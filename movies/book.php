...
<div class="content">
				...
				<div class="col-md-10">
					<div class="section group">
						<div class="about span_1_of_21">
							<center>
								<h3 style="color:blue;text-transform:uppercase;font-weight:bold;">Movie Name : <?php echo $m_row['m_nm']; ?></h3>
							</center>
							<div class="about-top">
  ...
  color: #ffffff !important;" <?php  } else { ?> style="display:inline-block; background: red; height:20px;width:20px" <?php } ?> class="form-control" value="<?php echo $srow['seat_id']; ?>" <?php if ($srow['seat_uid'] != 0) {
																																																echo ' disabled';
																																															}  ?>>
